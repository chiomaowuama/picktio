...
<template>
    <div class="bg-yellowbg" >
        ...
        <div class=" flex py-16  px-10">
            <div class="text-white relative w-5/6 md:w-3/6 flex justify-center items-center md:p-16  ">
                <p class=" text-4xl font-extrabold md:text-5xl lg:text-7xl  font-textstyle tracking-tighter md:leading-0">Join <span class="text-black">live broadcasts</span>with your favourite people </p>
                <img src="https://pickt.io/live.svg" class="absolute w-16 -top-4 left-20 md:top-6 md:left-48 md:w-28">
                <img src="https://pickt.io/love.svg" class="absolute w-12 top-20 left-24 md:top-48 lg:top-64 md:left-64 md:w-20">
            </div>
        ...
        <transition name="leftmanual" appear>
            ...
            <div ref="carousel"  class="carousel scroll-smooth auto-cols-max  snap-mandatory overflow-auto  h-full  pl-10  gap-5 md:auto-rows-max " @mousedown="startDrag" @mousemove="handleDrag" @mouseup="endDrag" @scroll="infiniteScroll()">
                <div class="cards bg-white w-64  md:w-96  rounded-xl p-2">
                    <div class="imgs flex h-40 md:h-54 justify-center rounded-3xl items-center p-2 backgrounds bcone">
                    ...
                    <div class=" relative  bg-white rounded-2xl rounded-tl-none rounded-tr-none">
                        <div class="flex w-max  absolute -top-12 left-4 md:left-28 px-2 py-1 rounded-full bg-white justify-center gap-2 items-center  ">
                            <img class="w-4" src="@/assets/profile.svg">
                        ...
                        <div class="p-2 pl-2 pb-2 md:pb-4 rounded-2xl space-y-2 md:space-y-3">
                            <div class="flex">
                                <p class="flex font-semibold w-full">Live Orchestra </p>
                            </div>
                            <div class="flex gap-2 items-center">   
                                <img class="w-6" loading="eager" src="@/assets/money.svg" alt="Malaika Ademola-Majekodunmi">
                                <p class=" text-lg font-semibold">$30+ <span class="text-neutral-400">/person</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="cards cardone bg-white w-64  md:w-96  rounded-xl p-2">
                    <div class="imgs flex h-40 md:h-54 justify-center rounded-3xl items-center p-2 backgrounds bctwo">
                        <!-- <img class="w-32 md:w-80 md:h-96 rounded-xl " src="https://pickt.io/malaika.png" alt="Malaika Ademola-Majekodunmi" > -->
                    </div>
                    <div class=" relative  bg-white rounded-2xl rounded-tl-none rounded-tr-none">
                ...
                <div class=" cards cardone bg-white w-64  md:w-96  rounded-3xl p-2">
                    <div class=" flex md:h-54 h-40 justify-center rounded-xl items-center p-2 backgrounds bcthree ">
                        <!-- <img class="w-32 md:w-80 md:h-96 rounded-xl " src="https://pickt.io/malaika.png" alt="Malaika Ademola-Majekodunmi" > -->
                    </div>
                    <div class=" relative  bg-white rounded-2xl rounded-tl-none rounded-tr-none">
                        ...
                        <div class="p-2 pl-2 pb-4 md:pb-4 rounded-2xl space-y-2 md:space-y-3">
                            <div class="flex">
                ...
                <div class=" cards cardone bg-white w-64  md:w-96  rounded-3xl p-2">
                    <div class=" flex h-40 md:h-54 justify-center rounded-xl items-center p-2 backgrounds bcfour">
        ...
        <div class="flex justify-center align-middle py-16 ">
            <button class=" w-44 px-3 py-3 rounded-xl  text-white bg-black font-semibold font-textstyle text-lg md:text-sm">Discover Experts</button>
        </div>
