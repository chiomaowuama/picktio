...
<template>
    <div class="bg-white" >
        ...
        <div class=" flex py-16  px-10">
            ...
            <div class="hidden w-3/6 md:flex justify-center space-x-4 pb-16  ">
                <button class="firstchild self-end border border-pinktext rounded-full p-5  hover:bg-hovers " @click="arrowBtns('left')" id="left"  >
                    <svg xmlns="http://www.w3.org/2000/svg"  width="32" height="32" viewBox="0 0 24 24" fill="none"><path stroke="#ef3867" class="border-2 border-yellow-900"  stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.57 5.93L3.5 12l6.07 6.07M20.5 12H3.67"></path></svg>
                </button>
                <button class="secondchild self-end border border-pinktext rounded-full p-5 hover:bg-hovers " @click="arrowBtns('right')" id="right">
                    <svg xmlns="http://www.w3.org/2000/svg"  width="32" height="32" viewBox="0 0 24 24" fill="none"><path stroke="#ef3867" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.43 5.93L20.5 12l-6.07 6.07M3.5 12h16.83"></path></svg>
                </button>
            </div>
        ...
        <transition name="leftmanual" appear>
            ...
            <div ref="carousel"  class="carousel scroll-smooth auto-cols-max  snap-mandatory overflow-auto   h-full  pl-10  gap-5 md:auto-rows-max " @mousedown="startDrag" @mousemove="handleDrag" @mouseup="endDrag" @scroll="infiniteScroll()">
                <div class="card bg-white w-64  md:w-96  rounded-xl p-2">
                    <div class="imgs flex h-60 md:h-80 justify-center rounded-xl items-center p-2 background akpovire">
                        <!-- <img class="w-32 md:w-80 md:h-96 rounded-xl " src="https://pickt.io/malaika.png" alt="Malaika Ademola-Majekodunmi" > -->
                    </div>
                    <div class=" relative text-white rounded-2xl rounded-tl-none rounded-tr-none">
                        <div class="absolute -top-24 left-16 p-2 pl-2  rounded-2xl space-y-3 md:space-y-2">
                            <div class="flex">
                ...
                <div class=" card bg-white w-64  md:w-96  rounded-xl p-2">
                    <div class=" flex md:h-80 h-60 justify-center rounded-xl items-center p-2 background orbay">
                        <!-- <img class="w-32 md:w-80 md:h-96 rounded-xl " src="https://pickt.io/malaika.png" alt="Malaika Ademola-Majekodunmi" > -->
                    </div>
                    <div class=" relative  bg-white rounded-2xl rounded-tl-none rounded-tr-none">
                      
                        <div class="text-white absolute -top-24 left-16 p-2 pl-2 pb-4 md:pb-8 rounded-2xl space-y-3 md:space-y-2">
                            <div class="flex">
                ...
                <div class=" card bg-white w-64  md:w-96  rounded-xl p-2">
                    <div class=" flex h-64  md:h-80 justify-center rounded-xl items-center p-2 background alicia">
                        <!-- <img class="w-32 md:w-80 md:h-96 rounded-xl " src="https://pickt.io/malaika.png" alt="Malaika Ademola-Majekodunmi" > -->
                    </div>
                    <div class=" relative  bg-white rounded-2xl rounded-tl-none rounded-tr-none">
                ...
                <div class=" card bg-white w-64  md:w-96  rounded-xl p-2">
                    <div class=" flex h-60 md:h-80 justify-center rounded-xl items-center p-2 background shane">
        ...
        <div class="flex justify-center align-middle py-16 ">
            <button class=" w-36 px-3 py-3 rounded-xl  text-white bg-black font-semibold font-textstyle text-sm">Discover Experts</button>
        </div>
